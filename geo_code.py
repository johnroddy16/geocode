# this program will take a location from a user and fetch data about that location and display
# it to the user. the program will use the geocode api and store the data retrieved in a database
# if the location already exists in the database the API will not be called and the data will be 
# fetched and displayed from the database: 
